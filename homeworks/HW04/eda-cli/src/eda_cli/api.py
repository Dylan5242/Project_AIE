...
@app.post(
    ...
    tags=["quality"],
    summary="Получить флаги качества данных с добавлением эвристик из HW03",
)
async def quality_flags_from_csv(file: UploadFile = File(...)) -> dict:
    """
    Принимает CSV-файл и возвращает флаги качества данных,
    вычисленные на основе эвристик из HW03.
    """
